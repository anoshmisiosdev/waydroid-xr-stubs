...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "release-1.1.38"
  WORKING_DIRECTORY "/Users/riyananosh/waydroid-xr-stubs/host/build/_deps/openxr-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "release-1.1.38")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("release-1.1.38" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: release-1.1.38")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/release-1.1.38")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"release-1.1.38\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/riyananosh/waydroid-xr-stubs/host/build/_deps/openxr-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/riyananosh/waydroid-xr-stubs/host/build/_deps/openxr-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
